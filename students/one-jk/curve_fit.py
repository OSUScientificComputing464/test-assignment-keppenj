...
plt.plot(x, zfit(x), '-', label = "All data") #Plotting all of the points
#plt.plot(x,zfit2(x), '-.', label = "Trimmed data")
plt.plot(x,zfit3(x), 'o', label = "Min. 3 points")
